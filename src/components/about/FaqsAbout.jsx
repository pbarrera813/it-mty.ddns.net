...
const SkillsList = () => {
  ...
  const skills = {
    "¿Qué tecnologías uso?": [
      "Actualmente trabajo con tecnologías como Python, C++, React, Astro, Boostrap y demas librerias y frameworks, igualmente para el backend manejo tecnologias como Node.js, Firebase, PHP, entre otras.",
    ],
    "Mi Experiencia": [
      "Mi experiencia comenzó dentro de la empresa John Deere como Practicante de Ingeniero en Infraestructura, en la cual pude llevar a cabo los conocimientos adquiridos a lo largo de mis estudios universitarios, esta oportunidad de empleo me otorgó una experiencia laboral real para poder conocer y adentrarme mejor en la vida laboral, dentro de esta posición pude llevar a cabo el uso de Microsoft PowerApps, para automatizar procesos dentro de la empresa.",
    ],
    "Mi formacion": [
      "Mi educación consiste en haber estudiado la carrera de Ingeniero en Tecnología del Software en la Universidad Autónoma de Nuevo León, después de haber terminado esta carrera en Noviembre del 2025, gracias a la experiencia adquirida dentro de la carrera,           decidí adentrarme con mayor profundidad al sistema operativo Linux e igualmente al lenguaje de programación Python, esto con el objetivo de pulir y mejorar los conocimientos adquiridos, pues estar en un constante aprendizaje es algo que nunca esta de más.",
    ],
    "¿Cómo trabajo en equipo?": [
      "Durante mi estadia como practicante en John Deere, pude adquirir satisfactoriamente una experiencia real de como funciona un equipo de trabajo, mediante las metodologías Scrum y Agile, mismas que son de una gran importancia hoy en día, utilizadas en la mayoría de equipos de desarrollo en la actualidad. Además de esto, tambien utilicé herramientas de control de versiones como Git y GitHub para gestionar el flujo de trabajo y proyectos. También cuento con experiencia utilizando Jira, facilitando la colaboración dentro del equipo.",
    ],
    "Metodolgias Agiles": [
      "He trabajado con metodologías ágiles como Scrum y Agile. En Scrum, participé en sprints de dos semanas, donde al finalizar cada sprint se realizaba una junta en donde se revisaban los avances del equipo, esto con el fin de mantener un control y una buena organización del mismo. También he trabajado con Kanban, utilizando tableros para gestionar tareas y moverlas según su estado de progreso. Además, participé en reuniones diarias (dailies) para planificar y reportar avances del proyecto, asegurando una comunicación eficiente dentro del equipo.",
    ],
  };
